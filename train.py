...
parser.add_argument('--sam2_checkpoint', type=str, default='checkpoints/sam2.1_hiera_large.pt', help='SAM2 checkpoint path')
parser.add_argument('--sam2_config_dir', type=str, default='/home/hoge/sam2/sam2/configs', help='SAM2 hydra config directory')
parser.add_argument('--sam2_model_cfg', type=str, default='sam2.1/sam2.1_hiera_l', help='SAM2 model config name')
